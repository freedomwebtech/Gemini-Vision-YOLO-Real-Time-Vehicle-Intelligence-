...
# ====== Initialize Car Direction Tracking ======
car_up = {}
car_down = {}
...
class VehicleDetectionProcessor:
    def __init__(self, yolo_model_path="yolo12n.pt"):
        ...
        # Define ROI Areas
        self.area = np.array([(223, 375), (287, 477), (386, 456), (297, 366)], np.int32)
        ...
        # Create Output File Header if not exists
    ...
    def start_processing(self):
        ...
        while True:
            ...
            cv2.polylines(processed_frame, [self.area], True, (0, 255, 0), 2)
